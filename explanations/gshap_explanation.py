...
class GShapExplanation(BaseExplanation):
    ...
    def __init__(self, opt):
        super(GShapExplanation, self).__init__(opt)
    ...
    def plot(self, save_path: str = None):
        ...
        cb = plt.colorbar(im, ax=np.ravel(axes).tolist(), label="GSHAP value", orientation="horizontal", aspect=30)
