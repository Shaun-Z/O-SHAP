...
class IntegratedGradientsExplanation(BaseExplanation):
    ...
    def __init__(self, opt):
        super(IntegratedGradientsExplanation, self).__init__(opt)
    ...
    def plot(self, save_path: str = None):
        ...
        cb = plt.colorbar(im, ax=np.ravel(axes).tolist(), label="Integrated Gradients value", orientation="horizontal", aspect=30)
