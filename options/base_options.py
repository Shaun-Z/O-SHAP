...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', '-m', type=str, default='cycle_gan', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_name', type=str, default='mnist', help='name of the dataset [mnist]')
