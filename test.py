...
for i, data in enumerate(dataloader):
    ...
    print(data['Y'], labels[index_max], data['Y'][0]==labels[index_max], np.argmax(data['Y_one_hot']).numpy(), index_max, predict_result[0,index_max])  # print the true label and the predicted label
'''
